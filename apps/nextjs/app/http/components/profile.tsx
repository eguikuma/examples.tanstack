...
import { Container, Head, Trigger } from '@shared/components'
  ...
  <Container>
    ...
    <div className="bg-white rounded-2xl border-4 border-gray-900 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.8)] overflow-hidden">
      ...
      <div className="p-8 bg-linear-to-b from-white to-gray-50">
        ...
        <div className="mb-6">
          <h2 className="text-xl font-bold mb-3 text-gray-900">タイプ</h2>
        ...
        <div className="mb-6">
          <h2 className="text-xl font-bold mb-4 text-gray-900">ステータス</h2>
        ...
        <div>
          <h2 className="text-xl font-bold mb-3 text-gray-900">特性</h2>
